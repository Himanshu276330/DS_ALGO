package DATA_STRUCTURE.CollectionFramework.L_46_Sets;
...
//        Set<DATA_STRUCTURE.String> fruits=new HashSet<>();
//
...
//            //Order of output-->[Apple, Kiwi, Banana]
                    ...
                    //Because it use DATA_STRUCTURE.LinkedList so time complexity is linear nor constant like set. but it add item in sequence
//        Set<DATA_STRUCTURE.String> fruits2=new LinkedHashSet<>();
//
//            //add() Function also return boolean , return true if add, return false if not add for duplicate element [repeated]
//        fruits2.add("Apple");
//        fruits2.add("Banana");
...
//          Set<DATA_STRUCTURE.String> fruits3=new TreeSet_Demo<>();
//
//            //add() Function also return boolean , return true if add, return false if not add for duplicate element [repeated]
//        fruits3.add("Apple");
//        fruits3.add("Banana");
