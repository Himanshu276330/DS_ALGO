...
//           String is immutable
        ...
        System.out.println(name.substring(4,15));        //15 walla index ka char include nahi hota h -- [4,15)

        System.out.println(name.contains("imansh"));
        System.out.println(name.contains("i"));
        System.out.println(name.contains("z"));

        System.out.println(name3.isBlank());  // jisme word nahi h
        System.out.println(name3.isEmpty());  //Space h usme isiliye false mila h
        ...
        String s="        Himanshu     Shikhar   Vishal       ";
        String s2=s.trim();
